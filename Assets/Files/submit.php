...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $to = "info@tgceastdelhi.com, info@tgc.com, info@tgcindia.com";  
    $subject = "New Form Submission: $formName";
    $headers = "From: info@tgceastdelhi.com\r\n";
    $headers .= "Reply-To: info@tgceastdelhi.com\r\n";
...
function sendConfirmationEmail($name, $email) {
    ...
    $headers = "From: info@tgceastdelhi.com\r\nReply-To: info@tgceastdelhi.com\r\nX-Mailer: PHP/" . phpversion();
